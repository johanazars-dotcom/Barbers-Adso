<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActualizarBarbero.aspx.cs" Inherits="AppBarbersAdso.Vista.ActualizarBarbero" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label runat="server" Text="Nombre Del Barbero:"></asp:Label><br />
